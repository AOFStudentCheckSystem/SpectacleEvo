        ...
        <f7-view navbar-fixed>
            ...
            <f7-pages>
                <f7-page>
                    ...
                    <virtual-scroller ref="virtualscroller" id="empty-card-list" containerTag="ul" mainTag="div"
                            ...
                            <li class="item-content media-item"
                                ...
                                <div class="item-inner">
                                    <div class="item-title-row">
                                        <div class="item-title">{{props.item.lastName + ', ' + props.item.firstName}}
                                        </div>
                                    </div>
                                    <div class="item-subtitle">{{props.item.preferredName || props.item.firstName}}
                                    </div>
                                </div>
                            </li>
                        </template>
